...
public class LocationService extends Service {
    ...
    public void onCreate() {
        ...
        notification = new NotificationCompat.Builder(this, AirKoalityApplication.CHANNEL_ID).setContentTitle("AirKoality Location Service").setContentText("Updating location").setSmallIcon(R.drawable.ic_location_searching_black_24dp).setContentIntent(pendingIntent).build();
        ...
        locationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                if (locationResult.getLocations().size() != 0) {
                    ...
                    preferences.edit().putFloat("latitude", (float) locationResult.getLocations().get(0).getLatitude()).putFloat("longitude", (float) locationResult.getLocations().get(0).getLatitude()).apply();
